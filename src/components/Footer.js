  ...
  return (
    <FooterStyle>
        ...
        <div className="footer__col3">
          <FooterCol
            ...
            links={[
              ...
              {
                title: 'vigneshpaulraj4@gmail.com',
                path: 'mailto:vigneshpaulraj4@gmail.com',
              },
              {
                title: 'Palava city, Mumbai, India',
        ...
        <div className="footer__col4">
          {/* <FooterCol
            ...
            links={[
              {
                title: 'Facebook',
                path: 'https://www.facebook.com/vegnesh.paulraj/',
              },
      ...
      <div className="copyright">
        <div className="container">
          <PText>© 2021 - Vignesh Paulraj| Designer </PText>
        </div>
      </div>
    </FooterStyle>
  );
