...
import blogPostImg from '../assets/images/blogPost.jpeg';
          ...
          <div className="top-section">
            <div className="left">
              <p className="about__subheading">
                This is a <span>Social networking app</span>
              </p>
              ...
              <div className="about__info__items">
                <div className="about__info__item">
                  ...
                  <AboutInfoItem
                    title="BackEnd"
                    items={['Node.js', 'Express', 'MongoDB', 'cloudinary']}
                  />
                </div>
              </div>
              <a
